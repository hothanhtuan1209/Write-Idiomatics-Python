...
- This pattern is widely used in Python code and may not be immediately
obvious to newcomers but greatly enhances code readability and functionality.
"""
...
def calculate_staistics(value_list):
    ...
    Returns:
        tuple: A tuple containing the mean, median, and mode of the input
        values.
    """
