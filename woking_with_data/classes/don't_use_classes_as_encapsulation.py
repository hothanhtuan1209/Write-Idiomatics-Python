...
- Modules are the preferred unit of encapsulation, and you can use 'all' to control which functions are importable from a module.
"""
...
def count_occurrences(string, key):
    """
    Counts the number of occurrences of a character or substring in the input string.
