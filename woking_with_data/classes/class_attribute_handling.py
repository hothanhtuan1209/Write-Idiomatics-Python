...
- If you need to refer to __tablename__ from within a Blog method, avoid
writing Blog.__tablename__.
- Creating a 'table_name' method in the Blog class that returns
'Blog.tablename' causes it to always reference 'Blog' and return 'blog' for
any derived class, which is not desired.
