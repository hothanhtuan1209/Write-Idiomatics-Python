...
- There are three general ways of formatting strings in Python:
using the + operator to concatenate a mix of static strings and variables,
using "old-style" string formatting with a format string and the % operator,
and using the format function.
