...
- They are iterable and can be used with the in statement. Sets are rooted in
mathematics and offer essential operations: union (A | B), intersection (A & B)
difference (A - B), and symmetric difference (A ^ B).
