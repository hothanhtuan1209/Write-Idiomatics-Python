...
- It simplifies the code by converting both lists to sets and finding common
elements using the & operator, making the task easier and more efficient than
using loops or other methods.
"""
...
def has_duplicate(list_one, list_two):
    ...
    Returns:
        set: A set containing elements that are duplicates between the two
        lists.
    """
