...
- Use properties in classes to prepare for potential changes in attribute handling.
- This allows you to add logic or calculations later without altering existing code.
"""
